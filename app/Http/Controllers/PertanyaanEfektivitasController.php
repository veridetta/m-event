...
class PertanyaanEfektivitasController extends Controller
{
    public function index(Request $request)
    {
        $kategori = kategori_pertanyaan::all();
        $kegiatan = kegiatan::all();
        $list_pertanyaan = PertanyaanEfektivitas::all();
    ...
    return view('pertanyaan.efektivitas', compact('kategori','kegiatan','list_pertanyaan'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $post   =   PertanyaanEfektivitas::updateOrCreate(['id' => $id],
                    [
        ...
        $pelaporan = PelaporanEfektivitas::create([
    ...
    {
        $where =  array('id' => $id);
           $post  = PertanyaanEfektivitas::where('id',$id)->first();
    ...
    {
    $where = array('id' => $id);
            $post  = PertanyaanEfektivitas::where($where)->first();
    ...
    {
        $post = PertanyaanEfektivitas::where('id',$id)->delete();
