...
class PelaporanPaskaPelaksanaanController extends Controller
{
    public function index(Request $request)
    {
        $list_pelaporan = PelaporanPaskaPelaksanaan::all();
        $kategori = kategori_pertanyaan::all();
        $kegiatan = kegiatan::all();
        $pertanyaans = PertanyaanPaskaPelaksanaan::all();
        if($request->ajax()){
    ...
    return view('pelaporan.paskapelaksanaan', compact('kategori','kegiatan','list_pelaporan', 'pertanyaans'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $id = $request->id;
        $post   =   PelaporanPaskaPelaksanaan::updateOrCreate(['id' => $id],
                    [
    ...
    {
        $where =  array('id' => $id);
        $post  = PelaporanPaskaPelaksanaan::where('id',$id)->first();
    ...
    {
            $where = array('id' => $id);
            $post  = PelaporanPaskaPelaksanaan::where($where)->first();
    ...
    {
        $post = PelaporanPaskaPelaksanaan::where('id',$id)->delete();
