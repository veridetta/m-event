...
class PertanyaanPaskaPelaksanaanController extends Controller
{
    public function index(Request $request)
    {
        $kategori = kategori_pertanyaan::all();
        $kegiatan = kegiatan::all();
        $list_pertanyaan = PertanyaanPaskaPelaksanaan::all();
    ...
    return view('pertanyaan.paskapelaksanaan', compact('kategori','kegiatan','list_pertanyaan'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $post   =   PertanyaanPaskaPelaksanaan::updateOrCreate(['id' => $id],
                    [
                    ...
                    $pelaporan = PelaporanPaskaPelaksanaan::create([
                        'kegiatan' => $namaKegiatan,
                        'pertanyaan1' => $request->pertanyaan1,
                        'pertanyaan2' => $request->pertanyaan2,
                        'pertanyaan3' => $request->pertanyaan3,
    ...
    {
        $where =  array('id' => $id);
           $post  = PertanyaanPaskaPelaksanaan::where('id',$id)->first();
    ...
    {
    $where = array('id' => $id);
            $post  = PertanyaanPaskaPelaksanaan::where($where)->first();
    ...
    {
        $post = PertanyaanPaskaPelaksanaan::where('id',$id)->delete();
