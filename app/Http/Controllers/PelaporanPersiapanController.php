...
class PelaporanPersiapanController extends Controller
{
    public function index(Request $request)
    {
        $list_pelaporan = PelaporanPersiapan::all();
        $kategori = kategori_pertanyaan::all();
        $kegiatan = kegiatan::all();
        $pertanyaans = PertanyaanPersiapan::all();
        if($request->ajax()){
    ...
    return view('pelaporan.persiapan', compact('kategori','kegiatan','list_pelaporan', 'pertanyaans'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $id = $request->id;
        $post   =   PelaporanPersiapan::updateOrCreate(['id' => $id],
                    [
    ...
    {
        $where =  array('id' => $id);
        $post  = PelaporanPersiapan::where('id',$id)->first();
    ...
    {
            $where = array('id' => $id);
            $post  = PelaporanPersiapan::where($where)->first();
    ...
    {
        $post = PelaporanPersiapan::where('id',$id)->delete();
