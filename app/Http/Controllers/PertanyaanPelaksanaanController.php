...
class PertanyaanPelaksanaanController extends Controller
{
    public function index(Request $request)
    {
        $kategori = kategori_pertanyaan::all();
        $kegiatan = kegiatan::all();
        $list_pertanyaan = PertanyaanPelaksanaan::all();
    ...
    return view('pertanyaan.pelaksanaan', compact('kategori','kegiatan','list_pertanyaan'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $post   =   PertanyaanPelaksanaan::updateOrCreate(['id' => $id],
                    [
                    ...
                    $pelaporan = PelaporanPelaksanaan::create([
                        'kegiatan' => $namaKegiatan,
                        'pertanyaan1' => $request->pertanyaan1,
                        'pertanyaan2' => $request->pertanyaan2,
                        'pertanyaan3' => $request->pertanyaan3,
    ...
    {
        $where =  array('id' => $id);
           $post  = PertanyaanPelaksanaan::where('id',$id)->first();
    ...
    {
    $where = array('id' => $id);
            $post  = PertanyaanPelaksanaan::where($where)->first();
    ...
    {
        $post = PertanyaanPelaksanaan::where('id',$id)->delete();
