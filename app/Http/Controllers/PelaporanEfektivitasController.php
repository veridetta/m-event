...
class PelaporanEfektivitasController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $id = $request->id;
        $post   =   PelaporanEfektivitas::updateOrCreate(['id' => $id],
                    [
    ...
    {
        $where =  array('id' => $id);
        $post  = PelaporanEfektivitas::where('id',$id)->first();
    ...
    {
            $where = array('id' => $id);
            $post  = PelaporanEfektivitas::where($where)->first();
    ...
    {
        $post = PelaporanEfektivitas::where('id',$id)->delete();
