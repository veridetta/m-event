...
@section('hero')
        ...
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img class="d-block w-100" src="{{ asset('assets/asset/header-1.jpeg') }}" alt="First slide">
                {{-- <img class="d-block w-100" src="..." alt="First slide"> --}}
              </div>
              <div class="carousel-item">
                <img class="d-block w-100" src="{{ asset('assets/asset/header-2.jpeg') }}" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="d-block w-100" src="{{ asset('assets/asset/header-3.jpeg') }}" alt="Third slide">
              </div>
            </div>
    ...
    <section id="search" class="services">
        ...
        <div class="container bg-secondary text-light p-3 rounded">
            <h2 class="text-center mb-4">Cari Kegiatan Berdasarkan</h2>
                ...
                @else
                    <div class="col-md-7 p-0">
                        ...
                        <div class="card mb-3 bg-light mt-2 mx-5 border-0 text-black"
                            ...
                            <img src="{{asset('files/'.$kegiatan->banner)}}" class="mx-auto d-block" style="width: 100%; height: auto;" alt="">
                            <div class="card-body">
                                <ul style="list-style: none; margin: 0; padding: 0;">
                                    <li>
                                        <small class="text-start">
                                            <ul style="list-style: none;">
                                                <h4 class="card-title">{{$kegiatan->namakegiatan}}</h5>
                                                <p class="card-text mb-0">
                                                    <h5><i class="icofont-clock-time"></i> {{ \Carbon\Carbon::parse($kegiatan->waktu)->format('l, d M Y h:i')}}<br>
                                                    <h5><i class="icofont-globe"></i> {{$kegiatan->jenis}}<br>
                                                    <h5><i class="icofont-location-pin"></i> {{$kegiatan->kota}}, {{$kegiatan->provinsi}} <br>
                                                </p>
                                                {{-- <li>
                                                ...
                                                <li>
                                                    <h5><i class="icofont-clock-time"></i> {{ \Carbon\Carbon::parse($kegiatan->waktu)->format('l, d M Y h:i')}}</h5>
                                        ...
                                        <div class="text-center">
                                            <a href="{{route('detailKegiatan.show',$kegiatan->id_kegiatan)}}" class="text-decoration-none btn btn-primary detail-more">Detail Event</a>
                                        </div>
                                    </li>
                                </ul>
                                            ...
                                            <div class="col-md-12 ">
                                                <div class="row">
                                                    <div class="col-lg-4 col-md-6 mb-2">
                                                        <img src="{{asset('files/'.$item->banner)}}" class="mx-auto d-block" style="width: 100%; height: auto;" alt="">
                                                    </div>
                                                    <div class="col-lg-8 col-md-6 mb-2">
                                                        <h5 class="card-title">{{$item->namakegiatan}}</h5>
                                                        <p class="card-text mb-0">
                                                            <i class="icofont-clock-time"></i> {{ \Carbon\Carbon::parse($item->waktu)->format('l, d M Y h:i')}}<br>
                                                        ...
                                                        <a href="{{route('detailKegiatan.show',$item->id_kegiatan)}}" class="text-decoration-none btn btn-primary detail-more">Detail Event</a>
                                                    </div>
                                                </div>
                    ...
                    @if (\Carbon\Carbon::parse($DaftarKegiatan->waktu)->lt($dateNow))
                        <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-4">
                            <div class="card" style="width: 23rem;">
                                <img src="{{asset('files/'.$DaftarKegiatan->banner)}}" class="mx-auto d-block" style="width: 100%; height: auto;" alt="">
                                <div class="card-body">
                                    
                                    <ul style="list-style: none; margin: 0; padding: 0;">
                                        <h5 class="card-title">{{$DaftarKegiatan->namakegiatan}}</h5>
                                        <p class="card-text mb-0">
                                            <i class="icofont-clock-time"></i> {{ \Carbon\Carbon::parse($DaftarKegiatan->waktu)->format('l, d M Y h:i')}}<br>
                                        <i class="icofont-globe"></i> {{$DaftarKegiatan->jenis}}<br>
                                        <i class="icofont-location-pin"></i> {{$DaftarKegiatan->kota}}, {{$DaftarKegiatan->provinsi}} <br>
                                        </p>
                                        {{-- <p class="btn btn-danger disabled m-0" >Event berakhir</p>
                                        <a href="{{route('detailKegiatan.show',$DaftarKegiatan->id_kegiatan)}}" class="text-decoration-none btn btn-primary detail-more">Detail Event</a>
                                     --}}
                                        {{-- <li>
                                            <h6 class="text-info">{{$DaftarKegiatan->namakegiatan}}</h6>
                                        </li>
                                        <li>
                                            <h6><i class="icofont-clock-time"></i> {{ \Carbon\Carbon::parse($DaftarKegiatan->waktu)->format('l, d M Y h:i')}}
                                        </li>
                                        <li>
                                    ...
                                    <a href="{{route('detailKegiatan.show',$DaftarKegiatan->id_kegiatan)}}" class="btn btn-sm btn-primary">Detail Event</a>
                                </div>
                            </div>
                        </div>
                    @else
                        <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-4">
                            <div class="card" style="width: 23rem;">
                                <img src="{{asset('files/'.$DaftarKegiatan->banner)}}"class="mx-auto d-block" style="width: 100%; height: auto;" alt="Card image cap">
                                <div class="card-body">
                                    <ul style="list-style: none; margin: 0; padding: 0;">
                                        <h5 class="card-title">{{$DaftarKegiatan->namakegiatan}}</h5>
                                        <p class="card-text mb-0">
