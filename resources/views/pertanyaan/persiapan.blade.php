...
@section('title', 'Manajemen Pertanyaan Persiapan')

@section('content_header')
    <h1 class="m-0 text-dark">Manajemen Pertanyaan Persiapan</h1>
@stop
    ...
    <!-- JAVASCRIPT -->
        <script>
            ...
            $('body').on('click', '.edit-post', function () {
                ...
                $.get('persiapan/' + data_id + '/edit', function (data) {
            ...
            $('body').on('click', '.detail-modal', function () {
                    var data_id = $(this).data('id');
                    cache: false,
                    $.get('persiapan/'+data_id, function(data) {
