...
@section('title', 'Manajemen Pertanyaan Paska Pelaksanaan')

@section('content_header')
    <h1 class="m-0 text-dark">Manajemen Pertanyaan Paska Pelaksanaan</h1>
@stop
        ...
        <script>
            ...
            $(document).ready(function () {
                $('#table_pp').DataTable({
                    ...
                    serverSide: true, 
                    ajax: {
                        url: "{{ route('paskapelaksanaan.index') }}",
                        type: 'GET'
                    },
                    columns: [{
                            data: 'kegiatan',
                ...
                $("#form-tambah").validate({
                    submitHandler: function (form) {
                        ...
                        $.ajax({
                            data: $('#form-tambah')
                                .serialize(), 
                            url: "{{ route('paskapelaksanaan.store') }}", 
                            type: "POST", 
                            dataType: 'json', 
            ...
            $('body').on('click', '.edit-post', function () {
                ...
                $.get('paskapelaksanaan/' + data_id + '/edit', function (data) {
            ...
            $('body').on('click', '.detail-modal', function () {
                    var data_id = $(this).data('id');
                    cache: false,
                    $.get('paskapelaksanaan/'+data_id, function(data) {
