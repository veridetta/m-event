...
@section('title', 'Manajemen User EO')
<link href="{{ asset('assets/asset/Logo_Spero.png') }}" rel="icon">

@section('content_header')
    <h1 class="m-0 text-dark">Manajemen User EO</h1>
@stop
                            ...
                            <div class="modal-body">
                                <form id="form-tambah-edit" name="form-tambah-edit" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-12 control-label">Nama User EO <span class="text-danger">*</span></label>
                                                <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="email" class="form-control" id="email" name="email" placeholder="Masukkan email user EO" value="" required>
                                                </div>
                                            </div>
        ...
        <script>
            ...
            $('#tombol-hapus').click(function () {
                $.ajax({
                    ...
                    type: 'delete',
                    beforeSend: function () {
                        $('#tombol-hapus').text('Hapus User EO'); 
                    },
                    success: function (data) { 
                        setTimeout(function () {
