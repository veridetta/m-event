...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <a href="javascript:void(0)" class="btn btn-primary my-3" id="tombol-tambah">Tambah Narasumber Kegiatan</a>
                <br><br>
                            ...
                            <div class="modal-body">
                                <form id="form-tambah-edit" name="form-tambah-edit" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="col-sm-12 control-label">Nama Narasumber <span class="text-danger">*</span></label>
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="col-sm-12 control-label">Nomor Handphone <span class="text-danger">*</span></label>
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputJeniskelamin">Jenis kelamin <span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <tr>
                                            <td>
                                                <label for="exampleInputName">Pendidikan <span class="text-danger">*</span></label>
                                            </td>
                                            <td><select class="form-control" name="pendidikan" id="pendidikan"
                                                    placeholeder="Pekerjaan" onchange="show()" required>
                                    ...
                                    <div class="form-group">
                                        <tr>
                                            <td>
                                                <label for="exampleInputName">Pekerjaan <span class="text-danger">*</span></label>
                                            </td>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <p>Kamu yakin ingin menghapus data Narasumber Kegiatan?</p>
                            </div>
    ...
    <script>
        ...
        $('#tombol-tambah').click(function () {
            ...
            $('#modal-judul').html("Tambah Narasumber Kegiatan Baru");
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $('#tombol-tambah').html("Tambah Narasumber Kegiatan");
            $.get('narasumber/'+data_id+'/edit', function(data) {
                $('#modal-judul').html("Ubah Narasumber Kegiatan");
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                ...
                type: 'delete',
                beforeSend: function () {
                    $('#tombol-hapus').text('Hapus Narasumber'); 
                    },
                success: function (data) { 
                    setTimeout(function () {
