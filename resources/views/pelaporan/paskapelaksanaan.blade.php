...
@section('title', 'Manajemen Pelaporan Paska Pelaksanaan')

@section('content_header')
    <h1 class="m-0 text-dark">Manajemen Pelaporan Paska Pelaksanaan</h1>
@stop
        ...
        <script>
            ...
            $(document).ready(function () {
                $('#table_pp').DataTable({
                    ...
                    serverSide: true, 
                    ajax: {
                        url: "{{ route('lappaskapelaksanaan.index') }}",
                        type: 'GET'
                    },
                    columns: [{
                            data: 'kegiatan',
            ...
            $('body').on('click', '.edit-post', function () {
                ...
                $.get('lappaskapelaksanaan/' +data_id , function (data) {
                ...
                $("#form-tambah").validate({
                    submitHandler: function (form) {
                        ...
                        $.ajax({
                            data: $('#form-tambah')
                                .serialize(), 
                            url: "{{ route('lappaskapelaksanaan.store') }}", 
                            type: "POST", 
                            dataType: 'json', 
            ...
            $('#tombol-hapus').click(function () {
                $.ajax({
                    url: "lappaskapelaksanaan/" + dataId,
                    type: 'delete',
                    beforeSend: function () {
