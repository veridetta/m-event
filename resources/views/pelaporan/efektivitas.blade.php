...
@section('title', 'Manajemen Pelaporan Efektivitas')

@section('content_header')
    <h1 class="m-0 text-dark">Manajemen Pelaporan Efektivitas</h1>
@stop
                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12" id="detailjawaban3">
                                            </div>
        ...
        <script>
            ...
            $(document).ready(function () {
                $('#table_pp').DataTable({
                    ...
                    serverSide: true, 
                    ajax: {
                        url: "{{ route('lapefektivitas.index') }}",
                        type: 'GET'
                    },
                    columns: [{
                            data: 'kegiatan',
            ...
            $('body').on('click', '.edit-post', function () {
                ...
                $.get('lapefektivitas/' +data_id , function (data) {
                ...
                $("#form-tambah").validate({
                    submitHandler: function (form) {
                        ...
                        $.ajax({
                            data: $('#form-tambah')
                                .serialize(), 
                            url: "{{ route('lapefektivitas.store') }}", 
                            type: "POST", 
                            dataType: 'json', 
