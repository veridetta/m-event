...
@section('title', 'Manajemen Pelaporan Persiapan')

@section('content_header')
    <h1 class="m-0 text-dark">Manajemen Pelaporan Persiapan</h1>
@stop
    ...
    <!-- JAVASCRIPT -->
        <script>
            ...
            $('body').on('click', '.edit-post', function () {
                ...
                $.get('lappersiapan/' +data_id , function (data) {
