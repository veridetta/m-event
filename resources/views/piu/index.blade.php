...
@section('title', 'Manajemen PIU')
<link href="{{ asset('assets/asset/Logo_Spero.png') }}" rel="icon">

@section('content_header')
    <h1 class="m-0 text-dark">Manajemen PIU</h1>
@stop
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <a href="javascript:void(0)" class="btn btn-primary my-3" id="tombol-tambah">Tambah PIU</a>
                <br><br>

                <!-- Table -->
                <div class="table-responsive">
                <table class="table table-hover table-bordered table-stripped d-table dt-responsive nowrap" style="width: 100%" id="table_piu">
                    <thead>
                        <tr>
                    ...
                    <div class="modal-dialog ">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="form-tambah-edit" name="form-tambah-edit" class="form-horizontal" method="POST" action="">
                                    {{ csrf_field() }}        
                                    <input type="hidden" name="id" id="id">
                                        <input type="hidden" name="user_id" id="user_id">
            
                                            <div class="form-group">
                                                <label for="name" class="col-sm-12 control-label">Nama PIU<span class="text-danger"> *</span></label>
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control" id="name" name="name" placeholder="Nama PIU"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="NoHp" class="form-control" id="NoHp"
                                                    ...
                                                    maxlength="14" minlenght="11" value="{{ old('NoHp') }}" required>
                                                @error('number')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <select name="Kota" id="Kota" class="form-control required" data-width="100%" value="{{ old('Kota') }}">
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-12 control-label" id='lbpass' name='lbpass'>Password*</label>
                                                <div class="col-sm-12">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <p>Kamu yakin ingin menghapus data PIU?</p>
                            </div>
                ...
                <div class="modal fade" id="detail-modal" aria-hidden="true" tabindex="-1">
                    <div class="modal-dialog ">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="showmodal">Detail PIU</h5>
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            </div>
    ...
    <!-- JAVASCRIPT -->
        <script>
            ...
            $('#tombol-tambah').click(function () {
                ...
                $('#modal-judul').html("Tambah PIU Baru");
                    ...
                    submitHandler: function (form) {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {  
                                ...
                                var oTable = $('#table_piu').dataTable();
                                oTable.fnDraw(false);
                                iziToast.success({ 
            ...
            $('body').on('click', '.edit-post', function () {
                ...
                $.get('piu/' + data_id + '/edit', function (data) {
                    $('#modal-judul').html("Edit PIU");
            ...
            $('body').on('click', '.detail-modal', function () {
                    var data_id = $(this).data('id');
                    cache: false,
                    $.get('piu/'+data_id, function(data) {
                        $('#showmodal').html("Detail PIU");
