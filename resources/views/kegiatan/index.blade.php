                        ...
                        <form method="post" id="form-tambah-edit" name="form-tambah-edit" enctype="multipart/form-data" class="form-horizontal">
                                @csrf
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="col-sm-12 control-label">Banner Kegiatan <span class="text-danger">*</span></label>
                                        <div class="col-sm-12" id="tesBanner" required>
                                        </div>
                                        <input type="file" class="form-control" accept="image/*" id="banner" name="banner">
                                        {{-- <small id="bannerHelp" class="form-text text-muted">PNG, JPG, JPEG</small> --}}
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="col-sm-12 control-label">Nama Kegiatan <span class="text-danger">*</span></label>
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="col-sm-12 control-label">Tanggal & Waktu Kegiatan <span class="text-danger">*</span></label>
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="col-sm-12 control-label">Provinsi <span class="text-danger">*</span></label>
                                        <div class="col-sm-12">
                                            <select name="provinsi" id="provinsi" class="form-control required" data-width="100%" required>
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="col-sm-12 control-label">Kota <span class="text-danger">*</span></label>
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputNarasumber">Nama Narasumber<span class="text-danger">*</span></label>
                                        <select class="form-control" name="narasumber"
                                            value="{{ old('narasumber') }}" id="narasumber"
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputJeniskelamin">Status Kegiatan <span class="text-danger">*</span></label>
                                        <select class="form-control" name="status"
                                            value="{{ old('status') }}" id="status"
                                            placeholeder="Status Kegiatan" required>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputJeniskelamin">Jenis Pelaksanaan <span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="col-sm-12 control-label">Target Peserta <span class="text-danger">*</span></label>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="target" name="target" placeholder="Target Peserta"
                                            onkeypress="return onlyNumberKey(event)" value="" required>
                                        </div>
                                    </div>
    
                                    <div class="form-group">
                                        <label for="name" class="col-sm-12 control-label">Link Undangan <span class="text-danger">*</span></label>
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="col-sm-12 control-label">Deskripsi Kegiatan <span class="text-danger">*</span></label>
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="col-sm-12 control-label">Anggaran Diterima <span class="text-danger">*</span></label>
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="col-sm-12 control-label">Rundown <span class="text-danger">*</span></label>
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="col-sm-12 control-label">Media Promosi <span class="text-danger">*</span></label>
                                        <div class="col-sm-12">
...
<script>
    ...
    $('body').on('click', '.edit-post', function () {
        ...
        $.get('kegiatan/' + data_id + '/edit', function (data) {
            $('#modal-judul').html("Ubah Kegiatan");
            $('#tombol-simpan').val("edit-post");
            $('#tambah-edit-modal').modal('show');

            $('#id').val(data.id_kegiatan);
            $('#tesBanner').html('<img src="files/'+ data.banner +'" class="img-thumbnail mx-auto d-block" style="max-height:200px; max-width:200px;" />');
    ...
    $('#tombol-hapus').click(function () {
        $.ajax({
            ...
            type: 'get',
            beforeSend: function () {
                $('#tombol-hapus').text('Hapus Kegiatan'); 
            },
            success: function (data) { 
                setTimeout(function () {
