...
class CreatePelaporanPaskaPelaksanaansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pelaporan_paska_pelaksanaans', function (Blueprint $table) {
            $table->id();
            $table->foreignId('kegiatan_id')->nullable();
            $table->foreignId('PertanyaanPaskaPelaksanaan_id')->nullable();
    ...
    {
        Schema::dropIfExists('pelaporan_paska_pelaksanaans');
    }
}
