...
class CreatePertanyaanPersiapansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pertanyaan_persiapans', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('pertanyaan_persiapans');
    }
}
