...
class CreatePelaporanEfektivitasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pelaporan_efektivitas', function (Blueprint $table) {
            $table->id();
            $table->foreignId('kegiatan_id')->nullable();
            $table->foreignId('PertanyaanEfektivitas_id')->nullable();
    ...
    {
        Schema::dropIfExists('pelaporan_efektivitas');
    }
}
