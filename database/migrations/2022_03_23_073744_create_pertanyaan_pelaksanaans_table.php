...
class CreatePertanyaanPelaksanaansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pertanyaan_pelaksanaans', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('pertanyaan_pelaksanaans');
    }
}
