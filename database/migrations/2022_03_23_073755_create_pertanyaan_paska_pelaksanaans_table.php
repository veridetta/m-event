...
class CreatePertanyaanPaskaPelaksanaansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pertanyaan_paska_pelaksanaans', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('pertanyaan_paska_pelaksanaans');
    }
}
